CREATE TABLE IF NOT EXISTS default.stg_sales (
    nm_id UInt32,
    imt_name String DEFAULT NULL,
    vendor_code String DEFAULT NULL,
    history_dt Date DEFAULT NULL,
    history_open_card_count UInt32 DEFAULT NULL,
    history_add_to_cart_count UInt32 DEFAULT NULL,
    ...
    history_buyout_percent UInt32 DEFAULT NULL,
